...
public class RouteConvert {
     ...
     * @return
     */
    public static RouteDefinition toRouteDefinition(GatewayRoute routeEntity) {
     ...
     * @return
     */
    public static GatewayRoute toRouteEntity(RouteDefinition routeDefinition) {
        GatewayRoute routeEntity = new GatewayRoute();
